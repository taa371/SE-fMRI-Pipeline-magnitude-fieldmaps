...
cp -r "$Subdir"/func/unprocessed/rest/session_*/run_* "$Subdir"/func/rest # ADDED
mkdir "$Subdir"/func/xfms # ADDED
echo "0.69" >> "$Subdir"/func/xfms/EffectiveEchoSpacing.txt # ADDED (EVO echo spacing/dwell time in ms)
