...
for s = 1:length(sessions)
    ...
    for r = 1:length(runs)
        ...
        % calculate frame-wise displacement;
        [fd,rp_filt] = calc_fd_holland(rp_no_filt,tr);
...
% Add calc_fd_holland as a function here instead of a separate file

function [fd_temp, rp] = calc_fd_holland(Subdir,sessions)
